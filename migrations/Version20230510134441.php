 ...
 */
final class Version20230510134441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, target_post_id INT NOT NULL, content VARCHAR(255) NOT NULL, created_at DATE DEFAULT NULL, updated_at DATE DEFAULT NULL, INDEX IDX_9474526C7E3C61F9 (owner_id), INDEX IDX_9474526C80E1BA47 (target_post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `like` (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, target_post_id INT NOT NULL, created_at DATE DEFAULT NULL, updated_at DATE DEFAULT NULL, INDEX IDX_AC6340B37E3C61F9 (owner_id), INDEX IDX_AC6340B380E1BA47 (target_post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, target_post_id INT NOT NULL, for_like_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, is_read TINYINT(1) NOT NULL, created_at DATE DEFAULT NULL, updated_at DATE DEFAULT NULL, INDEX IDX_BF5476CA7E3C61F9 (owner_id), INDEX IDX_BF5476CA80E1BA47 (target_post_id), UNIQUE INDEX UNIQ_BF5476CAB9AE9D1F (for_like_id), UNIQUE INDEX UNIQ_BF5476CAF8697D13 (comment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, title VARCHAR(100) DEFAULT NULL, description LONGTEXT DEFAULT NULL, category VARCHAR(50) NOT NULL, place VARCHAR(100) DEFAULT NULL, state VARCHAR(50) DEFAULT NULL, city VARCHAR(50) DEFAULT NULL, location VARCHAR(100) DEFAULT NULL, rating INT NOT NULL, image VARCHAR(255) DEFAULT NULL, created_at DATE DEFAULT NULL, updated_at DATE DEFAULT NULL, INDEX IDX_5A8A6C8D7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, gender VARCHAR(15) DEFAULT NULL, bio LONGTEXT DEFAULT NULL, username VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, has_unread_notifications TINYINT(1) DEFAULT NULL, created_at DATE DEFAULT NULL, updated_at DATE DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CAB9AE9D1F FOREIGN KEY (for_like_id) REFERENCES `like` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP FOREIGN KEY FK_BF5476CAB9AE9D1F');
